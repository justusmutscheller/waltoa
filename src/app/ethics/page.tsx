...
export const metadata: Metadata = {
  title: "Ethics & responsibility — WALTOA",
  description:
    "WALTOA's ethics guideline: scientific integrity, transparent communication, sustainability, privacy and long-term value creation.",
};
...
export default function EthicsPage() {
  return (
    <LegalShell
      ...
      intro="WALTOA works at the meeting point of science, communication and sound. That position carries responsibility — to our clients, to the people who experience the work, and to the field itself. These principles are a standing commitment, not a slogan."
    >
